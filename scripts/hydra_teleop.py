    ...
    def joy_cb(self,msg):
        ...
        if msg.axes[self.DEADMAN[side]] < 0.01:
            ...
            if not self.deadman_engaged:
                ...
                new_mode = [oro_barrett_msgs.msg.BHandCmd.MODE_TRAPEZOIDAL] * 3 + [oro_barrett_msgs.msg.BHandCmd.MODE_VELOCITY]
                ...
                new_finger_cmd = [abs(old-new) > 0.1 for (old,cur,new) in zip(self.hand_cmd.cmd[:3], self.hand_position[:3], new_cmd[:3])]
